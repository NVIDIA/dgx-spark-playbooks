...
#   - OpenShell installed (the package-managed gateway is configured below)
...
# --- Pre-flight: configure and verify the authenticated package gateway ---
echo "--- Pre-flight: Verify OpenShell gateway ---"
bash "$REPO_DIR/scripts/ensure_openshell_gateway.sh"
echo ""
