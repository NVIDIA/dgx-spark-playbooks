#!/bin/bash
# Run the NCCL all_gather performance test across N nodes on multi-node capable hardware.
#
...
# interface with MGMT_IFNAME=<iface>. Override the buffer sweep with
# BEGIN/END/FACTOR (default 16G/16G/2).
#
