...
if ! /bin/ollama list | grep -q llama3.1:405b; then
    echo "No models found. Pulling llama3.1:405b (this may take 20-30 minutes)..."
    /bin/ollama pull llama3.1:405b
    echo "Successfully pulled llama3.1:405b"
else
